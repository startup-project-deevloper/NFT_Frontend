            ...
            <Box flex={1} mr={isMobile ? 0 : 9} mb={isMobile ? 3 : 0}>
              <Box display="flex" justifyContent="space-between">
                <Box display="flex" flexDirection="column">
                  ...
                  <Box fontWeight={800} fontSize={16} color="#65CB63">{`@${
              ...
              <Box mt={2} fontSize={14} fontWeight={400} color="#2D3047">
                {userProfile.bio}
              </Box>
            </Box>
            <Box flex={1}>
              <div className={classes.statLine}>
                {isLoadingUser ? (
                  ...
                  <>
                    ...
                    >
                      <Box fontSize={14} fontWeight={400} color={"#2D3047"} mb={1} whiteSpace="nowrap">
                        🌟 Followers
                      </Box>
                      <Box fontSize={35} color={"#2D3047"} fontWeight={800}>
                    ...
                    <div>
                      <Box fontSize={14} fontWeight={400} color={"#2D3047"} mb={1}>
                        💎 Badges
                      </Box>
                      {myBadges.length > 0 ? (
                        <LatestBadgesGrid

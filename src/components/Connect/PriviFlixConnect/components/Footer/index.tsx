  ...
  return (
    <Box width={1} className={classes.contentBox}>
      <Box className={classes.footerBox}>
        <Box ml={2}>
          <img src={require("assets/flixImages/privi.svg")} alt="privi" />
          <Box className={`${classes.title2} ${classes.findUs}`} mt={2} mb={1}>
            Find us on
          </Box>
        ...
        <Box className={classes.footerTextWrapper}>
          ...
          <Box className={classes.header1} mt={2} onClick={handleAppsLink} style={{ cursor: "pointer" }}>
            Apps
          </Box>

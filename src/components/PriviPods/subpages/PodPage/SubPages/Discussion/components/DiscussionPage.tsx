        ...
        <Box className="selected-discussion">
                  ...
                  {val.type === "text" ? (
                    ...
                    >
                      <Box
                        ...
                        onClick={() => {
                          setSelectedPhoto(
                            `${URL()}/podDiscussion/getMessagePhoto/${props.podId}/${topicView.id}/${val.message
                            }`
                          );
                          handleOpenModalDiscordPhotoFullScreen();
                        }}
                        style={{
                          backgroundImage: `url(${URL()}/podDiscussion/getMessagePhoto/${props.podId}/${topicView.id
                            }/${val.message})`,
                          backgroundPosition: "center",
                          backgroundRepeat: "no-repeat",
                          backgroundSize: "cover",
                    ...
                    >
                      <Box className="messageInfoVideo">
                        ...
                        <ReactPlayer
                          onClick={() => {
                            setSelectedVideo(
                              `${URL()}/podDiscussion/getMessageVideo/${props.podId}/${topicView.id}/${val.message
                              }`
                            );
                            handleOpenModalDiscordVideoFullScreen();
                          }}
                          url={`${URL()}/podDiscussion/getMessageVideo/${props.podId}/${topicView.id}/${val.message
                            }`}
                    ...
                    >
                      <Box className="messageInfoAudio">
                        <Waveform
                          url={`${URL()}/podDiscussion/getMessageAudio/${props.podId}/${topicView.id}/${val.message
                            }`}
                          mine={false}
                          showTime={false}
          ...
          {Object.keys(topicView).length > 0 ? (
            <Box className="inputDiscordChat">
              {!audioMessage && (
                <Box className="iconsDiscordMessage">
                  <Box className="iconImgDiscordMessage">
                    <img

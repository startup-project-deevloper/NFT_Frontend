          ...
          <LoadingWrapper loading={loadingLoan} theme={"blue"} height="calc(100vh - 100px)">
            ...
            >
              ...
              >
                ...
                <Box display="flex">
                    <Text style={{fontSize: '18px', color:'#1A1B1C', fontWeight: 800, fontFamily: 'Agrandir GrandHeavy'}}>Pricing Details</Text>
                </Box>

...
import { priviGovernanceConnectPageStyles } from "./index.styles";
...
const PriviSocialBox = () => {
  const classes = priviGovernanceConnectPageStyles();
  return (
        ...
        .then(async res => {
          if (res.data.success === true) {
            ...
            if (data.status === "authorized") {
              ...
              API.signInWithMetamaskWallet(account, web3, "Privi Governance").then(res => {
                if (res.isSignedIn) {
                  setSignedin(true);
  ...
  return (
    <Box className={classes.container}>
      <Box className={classes.navigationContainer}>
        <img src={require("assets/backgrounds/governance-gradient.png")} className={classes.gradient} />
        <img src={require("assets/logos/privi_governance_logo.png")} className={classes.logo} />
        <Box
        ...
        <Box display="flex" flexDirection="column" zIndex="1">
          <div className={classes.titleContainer}>
            <Box position="relative">
              <img
                src={require("assets/logos/privi_governance_logo.png")}
                className={classes.titleLogo}
                alt="Privi Governance"
              />
              ...
              {waitlisted ? (
                ...
                <>
                  ...
                  <Box className={classes.twitterShareContainer}>
                    <span>
                      I just joined the @priviprotocol waitlist for <b>Privi Governance</b> with {account}!
                      Join me to be one of the first people on <b>Privi Governance</b> and a chance to win up
                      to 200 USDC!{" "}
                      <a href="https://bit.ly/3BZT8tM" target="_blank">
                        https://bit.ly/3BZT8tM
                      </a>
                    </span>
                    <LoadingWrapper loading={tweetWaitlistLoading}>
                      <TwitterShareButton
                        title={`I just joined the @priviprotocol waitlist for Privi Governance with ${account}! Join me to be one of the first people on Privi Governance and a chance to win up to 200 USDC!`}
                        url="https://bit.ly/3BZT8tM"
                      >
                        <button
...
export default PriviGovernanceConnect;

...
import { ExpirationDayPaidStyles } from "./index.styles";
...
const ExpirationDayPaid = () => {
  const classes = ExpirationDayPaidStyles();
...
export default React.memo(ExpirationDayPaid);

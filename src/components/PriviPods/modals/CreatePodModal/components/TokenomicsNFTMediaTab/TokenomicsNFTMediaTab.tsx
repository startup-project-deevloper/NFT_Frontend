  ...
  return (
    <div className={classes.tokenomicsTab}>
              ...
              >
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                  <KeyboardDatePicker
                    ...
                    value={props.pod.FundingDate ?? new Date().setDate(new Date().getDate() + 1)}
                    onChange={(e: any) => props.setPod(prev => ({ ...prev, FundingDate: new Date(e).getTime() }))}
      ...
      <div className={classes.buttonCreatePodRow}>
        ...
        <div>
          <SecondaryButton size="medium" onClick={() => props.savePod()}>

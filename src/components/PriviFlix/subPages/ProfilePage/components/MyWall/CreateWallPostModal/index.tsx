    ...
    <Modal size="medium" isOpen={open} onClose={handleClose} showCloseIcon className={classes.root}>
      {!showPreview ? (
        <>
          ...
          <Box mb={3}>
            <Grid container direction="row" spacing={3}>
              <Grid item xs={6} md={3}>
                ...
                <Box fontSize={12} fontWeight={400} color="#ffffff">
              ...
              <Grid item xs={6} md={3}>
                <>
                  <Box mb={1} fontSize="18px" display="flex" alignItems="center" color="#ffffff">
                    Comments
                    <img
                      src={infoIcon}
                      alt="info"
          ...
          <Post theme="dark" title="Post description" editor={editor} setterEditor={setEditor} />
          {post.scheduled && (
...
const HashtagLabel = p => {
  return (
    <Box color="#FF5954" mr={2} mb={2} position="relative">

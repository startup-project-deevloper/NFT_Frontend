...
export async function mediaPodRegisterPodProposal(payload: any) {
  try {
    const response = await axios.post(`${URL()}/mediaPod/new/registerPodProposal`, payload);
    return response.data;
  } catch (e) {
    console.log(e);
    throw new Error(e.message);
...
export async function mediaPodVoteForPodProposal(payload: any) {
  try {
    const response = await axios.post(`${URL()}/mediaPod/new/voteForPodProposal`, payload);
    return response.data;
  } catch (e) {
    console.log(e);
    throw new Error(e.message);
...
export async function mediaPodExecutePod(payload: any) {
  try {
    const response = await axios.post(`${URL()}/mediaPod/new/executePod`, payload);
    return response.data;
  } catch (e) {
    console.log(e);
    throw new Error(e.message);

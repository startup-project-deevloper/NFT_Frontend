...
export default function LockNFT({ onClose, onCompleted, selectedNFT, currentNFT }) {
  const tokenAddress = selectedNFT.nftCollection.address;
  const tokenToId = selectedNFT?.nftTokenId;
        ...
        {isProceeding ? (
          <>
            <Box display="flex" alignItems="center" justifyContent="space-evenly">
              ...
              />
              <CircleSVG />
              <NFTCard item={selectedNFT} handleSelect={() => {}} isSmall />
            </Box>
            ...
            {approveBtn !== 0 ? (
              <Box display="flex" justifyContent="space-evenly">
                <button
                  ...
                  style={{
                    padding: "8px 60px",
                    backgroundColor: approveBtn !== 1 || isApproving ? "#431AB750" : "#431AB7",
                  }}

...
export default ({ isPaidBlocking, isUnpaidReserval }) => {
          ...
          <Box padding="32px 0" display="flex" alignItems="center" justifyContent="center">
            {
              isPaidBlocking ? (
                <>
                  <CheckIcon /><Box ml={2} fontFamily='Agrandir GrandHeavy' color="#4218B5">Blocking Paid</Box>
                </>
              ) : (
                <>
...
const CheckIcon = () => (
  <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 9.97619L9.68177 17L23 3" stroke="url(#paint0_linear_8545_124626)" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
    <defs>
      <linearGradient id="paint0_linear_8545_124626" x1="-11.236" y1="32.2571" x2="4.29076" y2="0.0907994" gradientUnits="userSpaceOnUse">

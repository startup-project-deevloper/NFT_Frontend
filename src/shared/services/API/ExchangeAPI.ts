...
export async function getBuyingOffers(exchangeId: string): Promise<any> {
  try {
...
export async function getExchangePriceHistory(exchangeId: string): Promise<any> {
  try {
...
export async function getExchangeTransactions(exchangeId: string): Promise<any> {
  try {

...
import { WithdrawCollateralModalStyles } from "./index.style";
import {typeUnitValue} from "shared/helpers/utils";
import { DateInput } from "shared/ui-kit/DateTimeInput";
import { Grid } from "@material-ui/core";

export default function WithdrawCollateralModal({ open, handleClose = () => {}, onConfirm }) {
  const classes = WithdrawCollateralModalStyles();

...
export default function ArtistPage() {
  ...
  let matchAlbums = albums
    ...
    .slice(0, 6);
  let matchPlaylists = playlists.slice(0, 6);
  let matchArtists = artists.filter(el => el.artist_name !== artist.artist_name).slice(0, 6);
        ...
        <div className={classes.content}>
          ...
          >
            <div className={classes.filter}>
              <h4>
                {artist.totalReproductions ? artist.totalReproductions.toLocaleString() : 0} Reproductions
              </h4>

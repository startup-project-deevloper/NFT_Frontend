  ...
  return (
    <>
      ...
      <Box mt={4} className={classes.BlockedDetailSection} padding="20px">
        <Box fontFamily="Agrandir GrandHeavy" fontSize={14}>Blocking payment:</Box>
        <Box mt={1} fontSize={14} >Your offer was accepted by the owner. You need to <b>pay remaining amount to buy the NFT at Future price before end of countdown</b> otherwise you will loose your collateral.</Box>
        <Box flex={1} mt="27px" display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Box display="flex" alignItems="center" flex={0.5} justifyContent="flex-end">
            <Box fontSize={14} textAlign="center" width="48px" mr="11px" >Time to pay</Box>

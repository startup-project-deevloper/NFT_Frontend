...
export default function BuyProceedModal({ open, offer, type, handleClose = () => {}, onConfirm }) {
    ...
    >
      <Box style={{ padding: "25px" }}>
        <Box fontSize="24px" color={type === "accept" ? "#431AB7" : "#FF253F"}>
          {type === "accept" ? "Accept Buy Offer" : "Decline Offer "}
        </Box>
        <Box className={classes.description}>
          {`${type === "accept" ? "Accept" : "Decline"} the offer from user [account] to buy the [NFT Name]`}
        </Box>

...
const DiscordReplyModal = (props: any) => {
  ...
  const replySendMessage = () => {
    if (messageReply) {
      let messageObj: any = {
        podDiscordRoom: props.message.discordRoom,
          ...
          <div className="messageInfoDiscordChatReply">
            ...
            <div className="actionsRowReply">
              {propsFunction.message.likes &&
                ...
                <div className="podIconCenterFlex" onClick={() => likeReplyMessage(propsFunction.message)}>
                  <SvgIcon>
                    <ThumbsUpSolid />
                  </SvgIcon>
                  &nbsp;{propsFunction.message.numLikes || 0}
              ...
              {propsFunction.message.dislikes &&
                ...
                <div className="podIconCenterFlex" onClick={() => dislikeReplyMessage(propsFunction.message)}>
                  <SvgIcon>
                    <ThumbsDownSolid />
                  </SvgIcon>
                  &nbsp;{propsFunction.message.numDislikes || 0}
            ...
            <div className="messageInfoDiscordChatReplyModal">
              ...
              {!message.type || message.type === "text" ? (
                ...
                <div className="messageInfoVideoReplyModal">
                  ...
                  />
                  <div className="podMessageAudioRow">
                    <div className="podProgressBarAudioRow">
                      <div
                        style={{
                          marginRight: "10px",
                          width: "20px",
                      ...
                      >
                        <div
                          className="podProgressBarAudioLoaded"
                          /*style={{width: '80%'}}*/
                          style={{
                        ...
                        ></div>
                        <div
                          className="podProgressBarAudioPlayed"
                          /*style={{width: '50%'}}*/
                          style={{
              ...
              <div className="actionsRowReplyModal">
                {message.likes && message.likes.findIndex(user => user === userSelector.id) !== -1 ? (
                  ...
                  <div className="podIconCenterFlex" onClick={() => likeMessage(message)}>
                    <SvgIcon>
                      <ThumbsUpSolid />
                    </SvgIcon>
                    &nbsp;{message.numLikes || 0}
                ...
                {message.dislikes && message.dislikes.findIndex(user => user === userSelector.id) !== -1 ? (
                  ...
                  <div className="podIconCenterFlex" onClick={() => dislikeMessage(message)}>
                    <SvgIcon>
                      <ThumbsDownSolid />
                    </SvgIcon>
                    &nbsp;{message.numDislikes || 0}

...
import { AfterOfferAcceptedStyles } from "./index.styles";
...
const AfterOfferAccepted = () => {
  const classes = AfterOfferAcceptedStyles();
          ...
          <LoadingWrapper loading={loadingLoan} theme={"blue"} height="calc(100vh - 100px)">
            ...
            >
              ...
              >
                ...
                <Box className={classes.priceBox1}>
                  <Box display="flex" justifyContent="space-between">
                    <div className={classes.priceBoxName} style={{color:'#181818'}}>Reserved price</div>
                    <div className={classes.priceBoxPrice}>2545 USDT</div>
                  </Box>
                </Box>
                <Box className={classes.priceBox2}>
									<Box display="flex" justifyContent="space-between">
...
export default React.memo(AfterOfferAccepted);

...
import { useBuyBackModelStyles } from "./index.style";

export default function BuyBackModel({ open, onClose, nft }) {
  const classes = useBuyBackModelStyles();
  ...
  return (
    <Modal size="small" isOpen={open} onClose={onClose} showCloseIcon className={classes.root}>
      <Box display="flex" flexDirection="column">
        ...
        {step === 0 ? (
          <BuyBack onClose={onClose} onCompleted={() => handleCompleteStep(0)} nft={nft} />
        ) : (

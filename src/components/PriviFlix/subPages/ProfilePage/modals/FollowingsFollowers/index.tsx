...
import { RedSlider } from "../../components/Feed";
import { getRandomAvatarForUserIdWithMemoization } from "shared/services/user/getUserAvatar";
import ClosenessDegreeModal from "../ClosenessDegreeModal";
import { profileFollowsModalStyles, RedText } from "./index.styles";
  ...
  ({
    ...
    return (
      <Modal className={classes.root} isOpen={open} onClose={onClose} showCloseIcon size="medium">
        ...
        <LoadingWrapper theme="light dark" loading={isLoadingFollows}>
          {!list ||
          list.filter(user => (header === "Followers" ? user.isFollower === 2 : user.isFollowing === 2))
            .length === 0 ? (
            <div>
            ...
            <>
              ...
              <Box mb={"32px"}>
                <Box color="#ffffff" fontSize="16px" mb="2">
                ...
                />
                <Box display="flex" justifyContent="space-between" color="#ffffff" mt={"6px"} fontSize="11px">
                  <Box>0</Box>
                  <Box>3.0</Box>
                </Box>
              </Box>
              <Box display="flex" alignItems="center" justifyContent="space-between" mb="16px">
                <h4>Users</h4>
                {ownUser && <h4>Closeness Degree 💫</h4>}
              </Box>
                    ...
                    <Box display="flex" mb={2} alignItems="center" justifyContent="space-between" key={index}>
                      ...
                      >
                        ...
                        <Box ml={"14px"}>
                          ...
                          <Box mt={"4px"} fontSize="11px" color="#FF5954">
        ...
        <LoadingWrapper theme="light dark" loading={loadingSuggestions}>

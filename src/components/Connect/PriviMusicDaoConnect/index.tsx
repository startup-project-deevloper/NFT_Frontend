        ...
        .then(async res => {
          if (res.data.success === true) {
            ...
            if (data.status === "authorized") {
              ...
              API.signInWithMetamaskWallet(account, web3, "Privi Trax").then(res => {
                if (res.isSignedIn) {
                  setSignedin(true);
      ...
      <Box className={classes.navigationContainer}>
        ...
        <Box className={classes.mainContainer} display="flex" flexDirection="column">
          <Box className={classes.backImages} position="relative">
            <img
              src={require("assets/musicDAOImages/orange.png")}
              style={{ top: 67, left: -67 }}
              alt="back1"
            />
            <img
              src={require("assets/musicDAOImages/music-green2.png")}
              style={{ top: -79, left: -55, width: 131 }}
              alt="back2"
            />
            <img
              src={require("assets/musicDAOImages/avocado.png")}
              style={{ top: -121, left: 116 }}
              alt="back3"
            />
            <img
              src={require("assets/musicDAOImages/music-green1.png")}
              style={{ top: -196, right: 0, width: 250 }}
              alt="back4"
            />
            <img src={require("assets/musicDAOImages/watermelon.png")} style={{ right: -42 }} alt="back5" />
          </Box>
          <Box className={classes.titleContainer} display="flex" alignItems="center" justifyContent="center">
            <Box position="relative">
              <img src={require("assets/logos/trax.png")} alt="Privi Music dao" className={classes.pixLogo} />
              ...
              {waitlisted ? (
                ...
                <>
                  ...
                  <Box className={classes.twitterShareContainer}>
                    <span>
                      I just joined the @priviprotocol waitlist for <b>Privi Trax</b> with {account}! Join me
                      to be one of the first people on <b>Privi Trax</b> and a chance to win up to 200 USDC!{" "}
                      <a href="https://bit.ly/3rO23Ke" target="_blank">
                        https://bit.ly/3rO23Ke
                      </a>
                    </span>
                    <LoadingWrapper loading={tweetWaitlistLoading}>
                      <TwitterShareButton
                        title={`I just joined the @priviprotocol waitlist for Privi Trax with ${account}! Join me to be one of the first people on Privi Trax and a chance to win up to 200 USDC!`}
                        url="https://bit.ly/3rO23Ke"
                        ref={twitterButton}
                      >
                        <button
...
export default PriviMusicDaoConnect;

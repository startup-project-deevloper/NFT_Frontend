...
const arePropsEquals = (prevProps, currProps) => {
  return JSON.stringify(prevProps.pod) == JSON.stringify(currProps.pod)
    && JSON.stringify(prevProps.validationError) == JSON.stringify(currProps.validationError);
};
...
const TokenomicsNFTMediaTab = React.memo((props: any) => {
  ...
  const [tokenImage, setTokenImage] = useState<any>(props.tokenPhotoImg);
  ...
  useEffect(() => {
    if (props.validationError.tab === 'TOKENOMICS') {
      document.querySelector(`#${props.validationError.invalidField}`)?.scrollIntoView();
    }
  ...
  return (
    <div className={classes.tokenomicsTab}>
      {props.pod || !props.creation ? (
        <div>
          <Grid container spacing={2} direction="row" alignItems="flex-start" justify="flex-start">
            ...
            <Grid item xs={12} id="tokenSymbol">
              <RenderInputCreateModal
                name={"Token Symbol"}
                info={"Token Symbol"}
          ...
          <Grid container spacing={2} direction="row" alignItems="flex-start" justify="flex-start" id="tokenDescription">
            <Grid item xs={12}>
          ...
          <Box className={classes.supplyBox} id="fundingToken">
            ...
            <Box className={classes.flexRowInputs} ml={2}>
              <TokenSelect
          ...
          <Box className={classes.flexRowInputs} width={1} id="spreadToken">
            <RenderInputCreateModal
              name="Trading Spread (%)"
              info="Trading Spread (%)"
          ...
          <Grid container spacing={2} direction="row" alignItems="flex-start" justify="flex-start" id="maximumSupply">
            ...
            <Grid item xs={12} md={6} id="fundingPrice">
              <Box className={classes.flexRowInputs}>
                <RenderInputCreateModal
                  name="Funding Price"
                  info="Funding Price"
            ...
            <Grid item xs={12} md={6} id="maxPrice">
              <Box className={classes.flexRowInputs}>
                <RenderInputCreateModal
                  name="Maximum Price"
                  info="Maximum Price"
            ...
            <Grid item xs={12} md={6}>
              <div className={classes.flexRowInputs} style={{ marginTop: 31, width: "fit-content" }}>
      ...
      <Grid item xs={12} md={12} style={{ margin: "24px 0" }} id="ammField">
        <div className={classes.flexRowInputs}>
